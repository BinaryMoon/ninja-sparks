...
One of the things I am most pleased with is that I was able to turn it into a PWA so you can [install it on your phone](https://brush.ninja/camera/) and use it like a normal camera app, even offline. As long as you install it (or add it to your home screen), it will work almost the same as a normal camera app.
...
If you read this because of [Brush Ninja](https://brush.ninja) then you know I am very interested in animation. At one point I wanted to work for Pixar or Disney, but I ended up working in web dev and games instead. I still love animation and find the process and craft fascinating.
