...
That nostalgia stuck with me because I've since seen a few other companies that we worked with celebrating their 25th anniversaries too. In particular, we had close relationships with [RuneScape](https://play.runescape.com/) (a browser-based MMORPG), and [Raketspel](https://raketspel.se/) (a Swedish game developer) who both turn 25 this year and are still going strong. It's not just games either. [Wikipedia](https://wikipedia.com) also turns 25 this year. It's amazing to think that it's been around for that long, and it's still such a valuable resource for information; I still use it all the time.

---

## Lunacy

[Lunacy][lunacy-link] is a free design tool for Windows, Mac, and Linux. I normally use [Sketch](https://www.sketch.com/) on my Mac for vector design work but it's recently been adding more and more online features that I don't use. So I've been looking for a replacement. Lunacy offers many of the same features as Sketch and can even open and edit Sketch files!
...
{% include embed-image.html image="/images/updates/2026/lunacy-icons.png" caption="The Lunacy editor, editing some Brush Ninja icons" %}
...
Unlike many browser-based tools such as [Figma](https://www.figma.com/), Lunacy works fully offline. This is helpful if you have limited internet access, are travelling, or are working in a school environment with restricted networks. At the same time, it still supports sharing and collaboration when you are online.

{% include embed-image.html image="/images/updates/2026/lunacy-banner.png" caption="The Lunacy editor, creating a banner for Brush Ninja" %}
...
**[Try Lunacy][lunacy-link]**

[lunacy-link]: {% link _library/app/2026-01-26-lunacy.md %}
...
[Hacktivate](https://www.hacktivate.app) is a game for Mac and iOS that teaches hacking concepts through gameplay. It focuses on ethical hacking and basic cybersecurity skills. Instead of reading long tutorials, you learn by doing.
...
{% include embed-image.html image="/images/updates/2026/hacktivate-game.png" caption="The Hacktivate gameplay" %}

There is also an [online version of Hacktivate for Schools](https://www.hacktivate.io/) by the same developer, designed for classroom use. This makes it easy for teachers to use the game in lessons without installing anything.
...
{% include embed-youtube.html video="dltkRa6Dkf0" %}
...
[Watch Comet in Moominland on Youtube](https://www.youtube.com/watch?v=dltkRa6Dkf0)
...
### [Words.zip](https://words.zip/)

{% include embed-browsershots-thumb.html url="https://words.zip" %}
...
I've been watching [The Studio](https://www.imdb.com/title/tt23649128/) on Apple TV+ this last week. It's a short series that goes behind the scenes of a fictional movie studio, and it's glorious. The filming, writing, and acting are all fantastic.
...
I am also currently reading "[Everyone on This Train Is a Suspect](https://www.goodreads.com/book/show/167006698-everyone-on-this-train-is-a-suspect)" by Benjamin Stevenson. I picked it up at random in a second-hand bookshop this weekend and am really enjoying it. The story is set on the Ghan train travelling across Australia from Adelaide to Darwin. On board are several mystery writers, some police, and, inevitably, a murder (although I have not reached that part yet).
