...
Still, it made me think about [the last issue]({% link _posts/2026/2026-06-29-issue-38-niche-sites.md %}), where I wrote about social media swallowing more of the internet. When fewer people make and share things on their own sites, perhaps there really is less interesting stuff to stumble across. Or perhaps I’m reading far too much into a quiet fortnight.
...
{% include embed-browsershots.html url="https://ileivoivm.github.io/inkField/" %}
...
{% include embed-image.html image="/images/updates/2026/inkfield-sketch.png" alt="A screenshot of an abstract sketch being painted" %}
...
I also like that there’s [a public gallery of drawings](https://ileivoivm.github.io/inkField/gallery/). There aren’t many artworks that look like “something”. Instead, they are mostly patterns and abstract shapes. However, it’s fun to see what people have made and watch their strokes being replayed.
...
{% include embed-browsershots.html url="https://ileivoivm.github.io/inkField/gallery/" %}
...
**[Try Inkfield][inkfield-link]**

[inkfield-link]: https://ileivoivm.github.io/inkField/

---

## ISS: “Crazy Beautiful!”

{% include embed-youtube.html video="22mTjdmpG1M" %}
...
[Watch the video](https://www.youtube.com/watch?v=22mTjdmpG1M)

---

## Sparked Discoveries

Here are a few more joyful and interesting corners of the web I stumbled across recently:
...
### [In Every Language](https://walzr.com/in-every-language/happiness)

{% include embed-browsershots.html url="https://walzr.com/in-every-language/happiness" %}

This project looks at Wikipedia pages for the same topic in different languages and collects the main images they use. I have linked to [happiness](https://walzr.com/in-every-language/happiness), but you can explore almost any topic you like.

It’s a fascinating way to see how different cultures and languages represent the same concept. One of my favourites is the page for [toilet](https://walzr.com/in-every-language/toilet), which contains lots of different toilets and a few amusing selections, including the Bulgarian one.

I also like food-based topics such as [breakfast](https://walzr.com/in-every-language/breakfast) and [cake](https://walzr.com/in-every-language/cake). Partly because I like food, but also because they show how differently cultures can represent the same thing.

### [Procreate Downloads](https://downloads.procreate.com/)

{% include embed-browsershots.html url="https://downloads.procreate.com/" %}
