---
title: Shoelaces, Rabbits, and More Niche Sites
date: 2026-06-29
related:
...
## [Ian's Shoelace Site](https://www.fieggen.com/shoelace/secureknot.htm) and the Disappearance of Niche Sites

Firstly, the [secure knot](https://www.fieggen.com/shoelace/secureknot.htm) is a great idea, and I'm surprised this is the first time I've seen it. I was in the Scouts as a child and know a lot of different knots, but the standard shoelace knot is what I was always taught. I will definitely be trying this. But more importantly, I found out about this site because of this article on [Aftermath](https://aftermath.site/ians-shoelace-site-is-still-the-best-destination-for-tying-your-shoes/).

{% include embed-browsershots.html url="https://www.fieggen.com/shoelace/secureknot.htm" %}

Aftermath is a site covering video games and the internet, and in the article they talk not only about how to tie shoelaces, but also why sites that hyperfocus on one thing are slowly disappearing from the web. Sites that are passion projects. Quirky little niches. Having used the internet since the mid-90s, I have seen many of these sites. In the early days, it's all there was. And I really like this sort of thing. It's what [NinjaSparks](https://ninjasparks.com) is all about.
...
That's one of the reasons my websites focus on interactive content. [Apps](https://photoedittools.com/), [games](https://beepmini.com/games/), and [creative tools](https://brush.ninja/) can't easily be replaced by AI, and people still have to visit my site to use them. More than that, they're my way of contributing to the kind of internet I still want to exist. Small, useful, playful corners of the web.
...
If you're interested, then [Blender]({% link _library/app/2025-03-20-blender.md %}) is a great free tool to get started with 3D animation, and there are a lot of free tutorials online to help you get started.

As an aside, if you want a career in animation, then the channel that posted this, [ClassCreatives](https://www.youtube.com/@ClassCreatives/videos), is a really good place to start. I also recommend the Pixar in a Box course on [Khan Academy](https://www.khanacademy.org/partner-content/pixar).

[Watch the video](https://www.youtube.com/watch?v=mfYfkmDwPVM)
...
## [Animation Hub](https://animationhub.eu/)

{% include embed-browsershots.html url="https://animationhub.eu/" %}
...
{% include embed-browsershots.html url="https://anthropeum.com/" %}
...
## [Play Geography](https://www.playgeography.com/)

{% include embed-browsershots.html url="https://www.playgeography.com/" %}

Speaking of geographic knowledge, this is a good one for learning the locations of countries. The games are simple and run in your browser. You just have to find the requested countries on a map. You can do the whole world or specific continents. There are also games for learning US states, flags (I have [a flag game](https://brush.ninja/play/country-flags/) too), capitals, and more. It's a good way to learn geography in a fun way.

## [Hostile Volume](https://hostilevolume.com/)

{% include embed-browsershots.html url="https://hostilevolume.com/" %}
...
I saw [Toy Story 5](https://www.imdb.com/title/tt29355505/) this weekend. I've seen all of the Toy Story films in the cinema, so I was looking forward to this one. Plus, the cinema is air-conditioned, which was a welcome relief from the heatwave.
