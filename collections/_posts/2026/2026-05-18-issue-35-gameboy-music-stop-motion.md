...
The biggest launch this week was a brand new Brush Ninja app: the [Stop Motion Animator](https://brush.ninja/create/stop-motion-animation/)!

It's been on my wish list for ages. I assumed it would be as complex as the main [Brush Ninja animation maker](https://brush.ninja/create/animation-maker/), so I kept putting it off, but it turned out to be surprisingly straightforward. I was able to reuse a lot of work from the [Pixel Camera app](https://brush.ninja/create/pixel-camera/), along with ideas and interface elements from the Animated GIF maker, which sped things up massively.
...
I've also been expanding the [Pixel Camera App](https://brush.ninja/create/pixel-camera/). The next update adds support for recording short pixelated animated GIF videos, which has been surprisingly entertaining to experiment with.
...
I've mentioned [GB Studio]({% link _library/app/2025-08-25-gameboy-studio.md %}) before. It's a fantastic free, open source game engine that lets you make games for the Game Boy. It's a really fun, simple way to build games with a minimal interface, and it's a great entry point into game development.

Recently, the main developer has been creating a new browser-based tool for making music for GB Studio games, which I find fascinating. It doesn't really have a proper name yet, but I'll call it [Gameboy Studio Music][gbstudio-music-link] for now.
...
I'd actually love to make something similar, albeit much simpler, for [BeepMini](https://beepmini.com), my web-based game-making app. This has definitely inspired me to stop procrastinating and finally get on with it. Especially since the current ["music editor"](https://beepmini.com/tools/beepmini-music-editor/) is basically just a textarea you edit manually, which may be the least user-friendly thing I've ever made 😬.
...
Laika have released a teaser trailer for their new film *Wildwood*. Their films are always a treat, and this one looks like they've really gone all out. Alongside [Aardman]({% link _posts/2026/2026-04-20-issue-33-london.md %}#aardman-at-the-young-va), Laika are one of the few studios still regularly making stop motion films. Every Laika film feels like a small miracle given how much work goes into every shot.

As much as I love 3D animation, there's something uniquely special about stop motion. *Wildwood* is based on a [2011 book of the same name](https://en.wikipedia.org/wiki/Wildwood_(novel)), which I haven't read, but the trailer makes it look like a dark, strange fantasy adventure that I immediately want to see more of.
...
If you like the look of it, the [Laika channel](https://www.youtube.com/@LAIKAStudios) also has a bunch of [behind-the-scenes videos](https://www.youtube.com/playlist?list=PLALN6nqI7sQLqIySvNwUoN1LEaEcHqycv) showing how these films are made. I've included a couple below, but there are loads more in the playlist.
