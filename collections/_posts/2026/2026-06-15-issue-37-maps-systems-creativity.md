...
[WWDC](https://www.youtube.com/watch?v=hF8swzNR1-o) is Apple's Worldwide Developers Conference, and I usually look forward to seeing what is coming next for Apple devices. Unfortunately, this year was largely about AI and not particularly exciting. The two things I was most interested in were the improvements to macOS design, which is currently a bit of a mess, and the improved child controls, which I'm surprised they didn't have before.

[The Nintendo Direct](https://www.youtube.com/watch?v=PvUPDSDZg1k), on the other hand, was a much more interesting presentation. A lot of the games they showed were Japanese role-playing games (JRPGs), which I don't play much, but there were still a few announcements that caught my eye.
...
So now I have a working engine and the beginnings of an editor that still needs a lot of work before it's usable. You can see [a few screenshots on Bluesky](https://bsky.app/profile/binarymoon.bsky.social/post/3mnrdpnevhk2s).

---

## The Man Who's Spent a Lifetime Making One, Giant Map

{% include embed-youtube.html video="Is8N7B9b0GQ" %}
...
[Watch the video](https://www.youtube.com/watch?v=Is8N7B9b0GQ)

---

## Entering Gerudo Fortress

{% include embed-youtube.html video="r8eMoxo4ipE" %}
[Watch the announcement video](https://www.youtube.com/watch?v=r8eMoxo4ipE)
...
{% include embed-youtube.html video="PFQInsvJy-4" %}
[Watch the fan animation](https://www.youtube.com/watch?v=PFQInsvJy-4)
...
{% include embed-youtube.html video="G-llkKMJxjY" %}
...
[Watch the trailer](https://www.youtube.com/watch?v=G-llkKMJxjY)
...
### [Quentin Blake Centre for Illustration](https://qbcentre.org.uk/)

{% include embed-browsershots.html url="https://qbcentre.org.uk/" %}
...
### [Elias Thorne's Chatbots and LLMs](https://www.404media.co/elias-thorne-chatbots-llms-chatgpt-lighthouse-keeper-story/)

{% include embed-image.html image="/images/updates/2026/elias-thorne.jpg" alt="The back of the head of a man looking over the sea" %}
...
### [Hallucinate](https://hallucinate.site/)

{% include embed-image.html image="/images/updates/2026/hallucinate.png" caption="Dancing at a virtual rave" %}
