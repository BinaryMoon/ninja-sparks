...
[Messenger][messenger-link] is a really clever 3D browser game where you control a 3D character who runs around a tiny spherical world. The goal is literally to be a messenger, doing fetch quests for the various inhabitants of the world.

{% include embed-image.html image="/images/updates/2025/messenger-1.png" caption="Messenger - a 3D Browser Game. That man is about to say something..." %}
...
{% include embed-image.html image="/images/updates/2025/messenger-2.png" caption="Helping a fisherman" %}
...
{% include embed-image.html image="/images/updates/2025/messenger-3.png" caption="Exploring the world with my doppelganger" %}
...
**[Play Messenger][messenger-link]**

[messenger-link]: https://messenger.abeto.co/

---

## Paddington the Musical

{% include embed-youtube.html video="JG5XS9cn4TY" %}

[Watch the trailer](https://www.youtube.com/watch?v=JG5XS9cn4TY)
...
{% include embed-youtube.html video="DCSmp-Ep-Ho" %}

[Watch the news clip](https://www.youtube.com/watch?v=DCSmp-Ep-Ho)
...
{% include embed-youtube.html video="caElrzVuAZg" youtube_thumbnail="https://i.ytimg.com/vi/caElrzVuAZg/sddefault.jpg" %}

[See how the costume works](https://www.youtube.com/watch?v=caElrzVuAZg)

I remember the first [Teenage Mutant Ninja Turtles movie](https://www.imdb.com/title/tt0100758/) had a similar approach, with actors in suits. But the Paddington Bear costume looks way more advanced, and the fact it's being puppeteered live every day adds an extra layer of magic.
